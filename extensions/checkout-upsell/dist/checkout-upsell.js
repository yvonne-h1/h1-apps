(() => {
  ...
  // extensions/checkout-upsell/src/Checkout.js
  var Checkout_default = extension("purchase.checkout.cart-line-list.render-after", (root, { lines, applyCartLinesChange, query, i18n }) => {
    let products = [];
    let loading = true;
